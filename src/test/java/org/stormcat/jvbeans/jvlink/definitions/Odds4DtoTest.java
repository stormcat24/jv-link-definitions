...
import org.stormcat.jvbeans.jvlink.definitions.dto.Odds4Dto;
 ...
 *
 */
public class Odds4DtoTest extends DefinitionsTestBase<Odds4Dto> {

    @Test
    public void test() {
        storedTest(StoredDataResolver._RACE()._O4(), "20100601000000", DataOption.STANDARD);
    }
