...
import org.stormcat.jvbeans.jvlink.definitions.dto.Odds6Dto;
 ...
 *
 */
public class Odds6DtoTest extends DefinitionsTestBase<Odds6Dto> {

    @Test
    public void test() {
        storedTest(StoredDataResolver._RACE()._O6(), "20100601000000", DataOption.STANDARD);
    }
