...
import org.stormcat.jvbeans.jvlink.definitions.dto.RefundDto;
 ...
 *
 */
public class RefundDtoTest extends DefinitionsTestBase<RefundDto> {

    @Test
    public void test() {
        storedTest(StoredDataResolver._RACE()._HR(), "20100701000000", DataOption.STANDARD);
    }
}
