...
import org.stormcat.jvbeans.jvlink.definitions.dto.Odds3Dto;
 ...
 *
 */
public class Odds3DtoTest extends DefinitionsTestBase<Odds3Dto> {

    @Test
    public void test() {
        storedTest(StoredDataResolver._RACE()._O3(), "20100601000000", DataOption.STANDARD);
    }
