...
import org.stormcat.jvbeans.jvlink.definitions.dto.Odds2Dto;
 ...
 *
 */
public class Odds2DtoTest extends DefinitionsTestBase<Odds2Dto> {

    @Test
    public void test() {
        storedTest(StoredDataResolver._RACE()._O2(), "20100601000000", DataOption.STANDARD);
    }
