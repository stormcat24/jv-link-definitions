...
import org.stormcat.jvbeans.jvlink.definitions.dto.Odds5Dto;
 ...
 *
 */
public class Odds5DtoTest extends DefinitionsTestBase<Odds5Dto> {

    @Test
    public void test() {
        storedTest(StoredDataResolver._RACE()._O5(), "20100601000000", DataOption.STANDARD);
    }
