...
import org.stormcat.jvbeans.jvlink.definitions.dto.CancelExclusionDto;
 ...
 *
 */
public class CancelExclusionDtoTest extends DefinitionsTestBase<CancelExclusionDto> {

    @Test
    public void test() {
        realTimeTest(RealTimeDataResolver._0B14()._AV(), RtOpenKeyFactory.createYYYYMMDD(2010, 7, 11));
    }
}
