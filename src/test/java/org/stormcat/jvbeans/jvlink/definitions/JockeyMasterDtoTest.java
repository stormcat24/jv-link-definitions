 ...
 *
 */
public class JockeyMasterDtoTest extends DefinitionsTestBase<JockeyMasterDto> {

    @Test
    public void test() {
        storedTest(StoredDataResolver._DIFF()._KS(), "20100601000000", DataOption.STANDARD);
    }
