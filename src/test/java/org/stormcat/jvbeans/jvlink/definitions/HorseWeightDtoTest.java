...
import org.stormcat.jvbeans.jvlink.definitions.dto.HorseWeightDto;
 ...
 *
 */
public class HorseWeightDtoTest extends DefinitionsTestBase<HorseWeightDto> {

    @Test
    public void test() {
        realTimeTest(RealTimeDataResolver._0B11()._WH(), RtOpenKeyFactory.createYYYYMMDD(2010, 7, 10));
    }
