 ...
 *
 */
public class HorseRaceInfoDtoTest extends DefinitionsTestBase<HorseRaceInfoDto> {

    @Test
    public void test() {
        storedTest(StoredDataResolver._RACE()._SE(), "20100601000000", DataOption.STANDARD);
    }
