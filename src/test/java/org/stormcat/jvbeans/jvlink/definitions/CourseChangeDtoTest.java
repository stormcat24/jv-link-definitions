...
import org.stormcat.jvbeans.jvlink.definitions.dto.CourseChangeDto;
 ...
 *
 */
public class CourseChangeDtoTest extends DefinitionsTestBase<CourseChangeDto> {

    @Test
    public void test() {
        realTimeTest(RealTimeDataResolver._0B14()._CC(), RtOpenKeyFactory.createYYYYMMDD(2010, 7, 11));
    }
