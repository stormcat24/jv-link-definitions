...
import org.stormcat.jvbeans.jvlink.definitions.dto.StartTimeChangeDto;
 ...
 *
 */
public class StartTimeChangeDtoTest extends DefinitionsTestBase<StartTimeChangeDto> {

    @Test
    public void test() {
        realTimeTest(RealTimeDataResolver._0B14()._TC(), RtOpenKeyFactory.createYYYYMMDD(2010, 7, 11));
    }
}
