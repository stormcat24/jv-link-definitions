...
import org.stormcat.jvbeans.jvlink.definitions.dto.Odds1Dto;
 ...
 *
 */
public class Odds1DtoTest extends DefinitionsTestBase<Odds1Dto> {

    @Test
    public void test() {
        storedTest(StoredDataResolver._RACE()._O1(), "20100601000000", DataOption.STANDARD);
    }
