 ...
 *
 */
public class TrainerMasterDtoTest extends DefinitionsTestBase<TrainerMasterDto> {

    @Test
    public void test() {
        storedTest(StoredDataResolver._DIFF()._CH(), "20100701000000", DataOption.STANDARD);
    }
}
