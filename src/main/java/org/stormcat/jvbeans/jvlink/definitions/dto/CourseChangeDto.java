...
package org.stormcat.jvbeans.jvlink.definitions.dto;
 ...
 /**
 * レコードフォーマットID {@link CC} に対応するDtoです。
 * @author jv-beans-gen
 * @since 0.1
 *
 */
@org.stormcat.jvbeans.annotation.JvBean(recordTypeId = "CC", byteLength = 50)
public class CourseChangeDto extends org.stormcat.jvbeans.jvlink.JvBindingDto {

    /**
     * {@code CC}に対応したデータ区分を表現するEnumです。
     * @author jv-beans-gen
     * @since 0.3
     *
     */
    public enum CourseChangeDataDiv implements org.stormcat.jvbeans.config.DataDiv {
         ...
         * @param value 値
         */
        private CourseChangeDataDiv(String name, String value) {
            this.name = name;
            this.value = value;
        }
    ...
    private org.stormcat.jvbeans.jvlink.definitions.code.TrackCd trackCdAfter;
    ...
    public org.stormcat.jvbeans.config.DataDiv getDataDiv() {
        return CourseChangeDataDiv.valueOf(java.lang.String.format("_%s", dataDiv));
    }
     ...
     * @return 変更後 トラックコード
     */
    public org.stormcat.jvbeans.jvlink.definitions.code.TrackCd getTrackCdAfter() {
        return trackCdAfter;
    }
     ...
     */
    public void setTrackCdAfter(org.stormcat.jvbeans.jvlink.definitions.code.TrackCd trackCdAfter) {
