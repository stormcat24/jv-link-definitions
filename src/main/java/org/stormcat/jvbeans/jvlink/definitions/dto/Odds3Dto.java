...
package org.stormcat.jvbeans.jvlink.definitions.dto;
 ...
 /**
 * レコードフォーマットID {@link O3} に対応するDtoです。
 * @author jv-beans-gen
 * @since 0.1
 *
 */
@org.stormcat.jvbeans.annotation.JvBean(recordTypeId = "O3", byteLength = 2654)
public class Odds3Dto extends org.stormcat.jvbeans.jvlink.JvBindingDto {

    /**
     * {@code O3}に対応したデータ区分を表現するEnumです。
     * @author jv-beans-gen
     * @since 0.3
     *
     */
    public enum Odds3DataDiv implements org.stormcat.jvbeans.config.DataDiv {
         ...
         * @param value 値
         */
        private Odds3DataDiv(String name, String value) {
            this.name = name;
            this.value = value;
        }
    ...
    /** ワイドオッズ */
    @org.stormcat.jvbeans.annotation.JvProperty(position = 41, byteLength = 17, repeatCount = 153)
    private java.util.List<org.stormcat.jvbeans.jvlink.definitions.dto.child.QuinellaPlaceaOddsDto> quinellaPlaceOddsItems;

    /** ワイド票数合計 */
    @org.stormcat.jvbeans.annotation.JvProperty(position = 2642, byteLength = 11)
    ...
    public org.stormcat.jvbeans.config.DataDiv getDataDiv() {
        return Odds3DataDiv.valueOf(java.lang.String.format("_%s", dataDiv));
    }
     ...
     * @return ワイドオッズ
     */
    public java.util.List<org.stormcat.jvbeans.jvlink.definitions.dto.child.QuinellaPlaceaOddsDto> getQuinellaPlaceOddsItems() {
        return quinellaPlaceOddsItems;
    }

    /**
     * ワイドオッズを設定します。
     * @param quinellaPlaceOddsItems ワイドオッズ
     */
    public void setQuinellaPlaceOddsItems(java.util.List<org.stormcat.jvbeans.jvlink.definitions.dto.child.QuinellaPlaceaOddsDto> quinellaPlaceOddsItems) {
        this.quinellaPlaceOddsItems = quinellaPlaceOddsItems;
    }
