...
package org.stormcat.jvbeans.jvlink.definitions.dto;
 ...
 /**
 * レコードフォーマットID {@link O4} に対応するDtoです。
 * @author jv-beans-gen
 * @since 0.1
 *
 */
@org.stormcat.jvbeans.annotation.JvBean(recordTypeId = "O4", byteLength = 4031)
public class Odds4Dto extends org.stormcat.jvbeans.jvlink.JvBindingDto {

    /**
     * {@code O4}に対応したデータ区分を表現するEnumです。
     * @author jv-beans-gen
     * @since 0.3
     *
     */
    public enum Odds4DataDiv implements org.stormcat.jvbeans.config.DataDiv {
         ...
         * @param value 値
         */
        private Odds4DataDiv(String name, String value) {
            this.name = name;
            this.value = value;
        }
    ...
    /** 馬単オッズ */
    @org.stormcat.jvbeans.annotation.JvProperty(position = 41, byteLength = 13, repeatCount = 306)
    private java.util.List<org.stormcat.jvbeans.jvlink.definitions.dto.child.ExactOddsDto> exactaOddsItems;

    /** 馬単票数合計 */
    @org.stormcat.jvbeans.annotation.JvProperty(position = 4019, byteLength = 11)
    ...
    public org.stormcat.jvbeans.config.DataDiv getDataDiv() {
        return Odds4DataDiv.valueOf(java.lang.String.format("_%s", dataDiv));
    }
     ...
     * @return 馬単オッズ
     */
    public java.util.List<org.stormcat.jvbeans.jvlink.definitions.dto.child.ExactOddsDto> getExactaOddsItems() {
        return exactaOddsItems;
    }

    /**
     * 馬単オッズを設定します。
     * @param exactaOddsItems 馬単オッズ
     */
    public void setExactaOddsItems(java.util.List<org.stormcat.jvbeans.jvlink.definitions.dto.child.ExactOddsDto> exactaOddsItems) {
        this.exactaOddsItems = exactaOddsItems;
    }
