...
package org.stormcat.jvbeans.jvlink.definitions.dto;
 ...
 /**
 * レコードフォーマットID {@link AV} に対応するDtoです。
 * @author jv-beans-gen
 * @since 0.1
 *
 */
@org.stormcat.jvbeans.annotation.JvBean(recordTypeId = "AV", byteLength = 78)
public class CancelExclusionDto extends org.stormcat.jvbeans.jvlink.JvBindingDto {

    /**
     * {@code AV}に対応したデータ区分を表現するEnumです。
     * @author jv-beans-gen
     * @since 0.3
     *
     */
    public enum CancelExclusionDataDiv implements org.stormcat.jvbeans.config.DataDiv {
         ...
         * @param value 値
         */
        private CancelExclusionDataDiv(String name, String value) {
            this.name = name;
            this.value = value;
        }
    ...
    public org.stormcat.jvbeans.config.DataDiv getDataDiv() {
        return CancelExclusionDataDiv.valueOf(java.lang.String.format("_%s", dataDiv));
    }
