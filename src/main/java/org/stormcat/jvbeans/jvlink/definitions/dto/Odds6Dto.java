...
package org.stormcat.jvbeans.jvlink.definitions.dto;
 ...
 /**
 * レコードフォーマットID {@link O6} に対応するDtoです。
 * @author jv-beans-gen
 * @since 0.1
 *
 */
@org.stormcat.jvbeans.annotation.JvBean(recordTypeId = "O6", byteLength = 83285)
public class Odds6Dto extends org.stormcat.jvbeans.jvlink.JvBindingDto {

    /**
     * {@code O6}に対応したデータ区分を表現するEnumです。
     * @author jv-beans-gen
     * @since 0.3
     *
     */
    public enum Odds6DataDiv implements org.stormcat.jvbeans.config.DataDiv {
         ...
         * @param value 値
         */
        private Odds6DataDiv(String name, String value) {
            this.name = name;
            this.value = value;
        }
    ...
    /** 3連単オッズ */
    @org.stormcat.jvbeans.annotation.JvProperty(position = 41, byteLength = 17, repeatCount = 4896)
    private java.util.List<org.stormcat.jvbeans.jvlink.definitions.dto.child.TrifectaOddsDto> trifectaOddsItems;

    /** 3連単票数合計 */
    @org.stormcat.jvbeans.annotation.JvProperty(position = 83273, byteLength = 11)
    ...
    public org.stormcat.jvbeans.config.DataDiv getDataDiv() {
        return Odds6DataDiv.valueOf(java.lang.String.format("_%s", dataDiv));
    }
     ...
     * @return 3連単オッズ
     */
    public java.util.List<org.stormcat.jvbeans.jvlink.definitions.dto.child.TrifectaOddsDto> getTrifectaOddsItems() {
        return trifectaOddsItems;
    }

    /**
     * 3連単オッズを設定します。
     * @param trifectaOddsItems 3連単オッズ
     */
    public void setTrifectaOddsItems(java.util.List<org.stormcat.jvbeans.jvlink.definitions.dto.child.TrifectaOddsDto> trifectaOddsItems) {
        this.trifectaOddsItems = trifectaOddsItems;
    }
