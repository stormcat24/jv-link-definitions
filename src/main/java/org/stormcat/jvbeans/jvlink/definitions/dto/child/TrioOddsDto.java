...
public class TrioOddsDto {
    ...
    /** 　　オッズ */
    @org.stormcat.jvbeans.annotation.JvProperty(position = 7, byteLength = 6)
    private java.lang.String odds;

    /** 　　人気順 */
    @org.stormcat.jvbeans.annotation.JvProperty(position = 13, byteLength = 3)
