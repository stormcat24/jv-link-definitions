...
package org.stormcat.jvbeans.jvlink.definitions.dto;
 ...
 /**
 * レコードフォーマットID {@link O2} に対応するDtoです。
 * @author jv-beans-gen
 * @since 0.1
 *
 */
@org.stormcat.jvbeans.annotation.JvBean(recordTypeId = "O2", byteLength = 2042)
public class Odds2Dto extends org.stormcat.jvbeans.jvlink.JvBindingDto {

    /**
     * {@code O2}に対応したデータ区分を表現するEnumです。
     * @author jv-beans-gen
     * @since 0.3
     *
     */
    public enum Odds2DataDiv implements org.stormcat.jvbeans.config.DataDiv {
         ...
         * @param value 値
         */
        private Odds2DataDiv(String name, String value) {
            this.name = name;
            this.value = value;
        }
    ...
    /** 馬連オッズ */
    @org.stormcat.jvbeans.annotation.JvProperty(position = 41, byteLength = 13, repeatCount = 153)
    private java.util.List<org.stormcat.jvbeans.jvlink.definitions.dto.child.QuinellaOddsDto> quinellaOddsItems;

    /** 馬連票数合計 */
    @org.stormcat.jvbeans.annotation.JvProperty(position = 2030, byteLength = 11)
    ...
    public org.stormcat.jvbeans.config.DataDiv getDataDiv() {
        return Odds2DataDiv.valueOf(java.lang.String.format("_%s", dataDiv));
    }
     ...
     * @return 馬連オッズ
     */
    public java.util.List<org.stormcat.jvbeans.jvlink.definitions.dto.child.QuinellaOddsDto> getQuinellaOddsItems() {
        return quinellaOddsItems;
    }

    /**
     * 馬連オッズを設定します。
     * @param quinellaOddsItems 馬連オッズ
     */
    public void setQuinellaOddsItems(java.util.List<org.stormcat.jvbeans.jvlink.definitions.dto.child.QuinellaOddsDto> quinellaOddsItems) {
        this.quinellaOddsItems = quinellaOddsItems;
    }
