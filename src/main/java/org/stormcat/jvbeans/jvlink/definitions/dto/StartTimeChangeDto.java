...
package org.stormcat.jvbeans.jvlink.definitions.dto;
 ...
 /**
 * レコードフォーマットID {@link TC} に対応するDtoです。
 * @author jv-beans-gen
 * @since 0.1
 *
 */
@org.stormcat.jvbeans.annotation.JvBean(recordTypeId = "TC", byteLength = 45)
public class StartTimeChangeDto extends org.stormcat.jvbeans.jvlink.JvBindingDto {

    /**
     * {@code TC}に対応したデータ区分を表現するEnumです。
     * @author jv-beans-gen
     * @since 0.3
     *
     */
    public enum StartTimeChangeDataDiv implements org.stormcat.jvbeans.config.DataDiv {
         ...
         * @param value 値
         */
        private StartTimeChangeDataDiv(String name, String value) {
            this.name = name;
            this.value = value;
        }
    ...
    private java.lang.String startTimeAfter;

    /** 変更前 発走時刻 */
    @org.stormcat.jvbeans.annotation.JvProperty(position = 40, byteLength = 4)
    ...
    public org.stormcat.jvbeans.config.DataDiv getDataDiv() {
        return StartTimeChangeDataDiv.valueOf(java.lang.String.format("_%s", dataDiv));
    }
     ...
     * @return 変更後 発走時刻
     */
    public java.lang.String getStartTimeAfter() {
        return startTimeAfter;
    }

    /**
     * 変更後 発走時刻を設定します。
     * @param startTimeAfter 変更後 発走時刻
     */
    public void setStartTimeAfter(java.lang.String startTimeAfter) {
    ...
    /**
     * 変更前 発走時刻を設定します。
     * @param startTimeBefore 変更前 発走時刻
     */
