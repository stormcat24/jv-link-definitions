...
package org.stormcat.jvbeans.jvlink.definitions.dto;
 ...
 /**
 * レコードフォーマットID {@link BR} に対応するDtoです。
 * @author jv-beans-gen
 * @since 0.1
 *
 */
@org.stormcat.jvbeans.annotation.JvBean(recordTypeId = "BR", byteLength = 537)
public class BreederMasterDto extends org.stormcat.jvbeans.jvlink.JvBindingDto {

    /**
     * {@code BR}に対応したデータ区分を表現するEnumです。
     * @author jv-beans-gen
     * @since 0.3
     *
     */
    public enum BreederMasterDataDiv implements org.stormcat.jvbeans.config.DataDiv {
         ...
         * @param value 値
         */
        private BreederMasterDataDiv(String name, String value) {
            this.name = name;
            this.value = value;
        }
    ...
    public org.stormcat.jvbeans.config.DataDiv getDataDiv() {
        return BreederMasterDataDiv.valueOf(java.lang.String.format("_%s", dataDiv));
    }
